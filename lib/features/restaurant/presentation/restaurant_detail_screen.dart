            ...
            children: [
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Variants picker — only renders when the partner defined
                      // at least one variant for this item. Async-loaded via
                      // foodItemVariantsProvider so we don't pay the round-trip
                      // for items that have none.
                      Consumer(
                        builder: (context, ref, _) {
                          final variantsAsync =
                              ref.watch(foodItemVariantsProvider(item.id));
                          return variantsAsync.maybeWhen(
                            data: (variants) {
              ...
              Container(
                ...
                child: Consumer(builder: (context, ref, _) {
                  // Resolve current variant list synchronously from the cache
                  // the provider populated above. The button copy & disable
                  // state both depend on whether variants exist and one is
                  // picked.
                  final variantsAsync = ref.watch(foodItemVariantsProvider(item.id));
